...
if &background == 'dark'
	...
	hi SpecialKey guifg=#38464a guibg=NONE guisp=NONE gui=NONE
	...
	if str2nr(&t_Co) >= 256
		...
		hi! DiffAdd    cterm=NONE ctermfg=235 ctermbg=Cyan
		hi! DiffDelete cterm=NONE ctermfg=DarkBlue ctermbg=DarkBlue
	...
	elseif str2nr(&t_Co) >= 16
		...
		hi! DiffAdd    cterm=NONE ctermfg=Yellow ctermbg=Cyan
		hi! DiffDelete cterm=NONE ctermfg=DarkBlue ctermbg=DarkBlue
	...
	hi SpecialKey guifg=#b9caca guibg=NONE guisp=NONE gui=NONE
	...
	if str2nr(&t_Co) >= 256
		...
		hi! DiffAdd    cterm=NONE ctermfg=220 ctermbg=Cyan
		hi! DiffDelete cterm=NONE ctermfg=DarkBlue ctermbg=DarkBlue
		hi! DiffChange cterm=NONE ctermfg=220 ctermbg=Green
		hi! DiffText   cterm=NONE ctermfg=White ctermbg=DarkYellow
	...
	elseif str2nr(&t_Co) >= 16
		...
		hi! DiffAdd    cterm=NONE ctermfg=Grey ctermbg=Cyan
		hi! DiffDelete cterm=NONE ctermfg=DarkBlue ctermbg=DarkBlue
		hi! DiffChange cterm=NONE ctermfg=Black ctermbg=Green
		hi! DiffText   cterm=NONE ctermfg=White ctermbg=DarkYellow
